...
PROTO_COLORS = {
    "AERIS": "#3E7BAA",   # slate blue (primary method highlight)
    "LEACH": "#D98C5F",   # soft orange
    "PEGASIS": "#6AAE8A", # desaturated green
    "HEED": "#B28CB8",    # muted violet
    "TEEN": "#C9A44C",    # warm ochre
}
