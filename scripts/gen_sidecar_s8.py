"""Generate provenance sidecar files for S8 scalability JSONs."""
...
files = [
    "scalability_outdoor_urban_server_s8_20260213.json",
    "scalability_outdoor_suburban_server_s8_20260213.json",
]
try:
