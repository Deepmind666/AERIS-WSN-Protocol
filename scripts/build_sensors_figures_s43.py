#!/usr/bin/env python3
"""
Sensors submission figures (S43): publication-style visual refinement
with softer palette, cleaner panel hierarchy, and stronger readability.

Outputs:
- fig0_aeris_workflow_20260221_s43.{pdf,svg,png}
- fig1_env_pdr_panel_20260221_s43.{pdf,svg,png}
- fig2_ablation_panel_20260221_s43.{pdf,svg,png}
- fig3_scalability_panel_20260221_s43.{pdf,svg,png}
- fig4_tradeoff_panel_20260221_s43.{pdf,svg,png}
- fig5_s11_patch_control_delta_20260221_s43.{pdf,svg,png}
- fig6_s10_power_sensitivity_20260221_s43.{pdf,svg,png}
- fig7_ns3_trend_panel_20260221_s43.{pdf,svg,png}
"""
