#!/usr/bin/env python3
"""
Sensors submission figures (S45): expanded evidence utilization with
three additional figures for significance, stress consistency, and
absolute tx-power behavior.

Outputs:
- fig0_aeris_workflow_20260221_s45.{pdf,svg,png}
- fig1_env_pdr_panel_20260221_s45.{pdf,svg,png}
- fig2_ablation_panel_20260221_s45.{pdf,svg,png}
- fig3_scalability_panel_20260221_s45.{pdf,svg,png}
- fig4_tradeoff_panel_20260221_s45.{pdf,svg,png}
- fig5_s11_patch_control_delta_20260221_s45.{pdf,svg,png}
- fig6_s10_power_sensitivity_20260221_s45.{pdf,svg,png}
- fig7_ns3_trend_panel_20260221_s45.{pdf,svg,png}
- fig8_s8_significance_heatmap_20260221_s45.{pdf,svg,png}
- fig9_s9_s11_consistency_20260221_s45.{pdf,svg,png}
- fig10_s10_absolute_profiles_20260221_s45.{pdf,svg,png}
- fig11_s11_significance_panel_20260221_s45.{pdf,svg,png}
"""
