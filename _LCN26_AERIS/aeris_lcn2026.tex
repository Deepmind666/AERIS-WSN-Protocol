...
Recent work has improved reliability through learning, hybrid control, context-aware routing, or deployment adaptation \cite{Chen2019Survey,Naeem2024DRL,Scientific2025DRLGNN,Tossa2025Deployment,Wang2024Geographic,Khedr2025ContextAware,Almutairi2025SSIPaS}. AERIS is adjacent to this line of work, but it keeps the runtime logic deliberately simple: fixed coefficients, explicit control paths, and no training-time dependence. Recent 2024--2025 surveys further show the same drift toward richer control planes, LLN management, and AI-driven routing \cite{Almutairi2024LLNSurvey,Djennadi2025SDNLLN,Thakur2025AIReview}. Concrete routing designs continue to explore reinforcement learning, mobile-sink adaptation, hybrid clustering, and federated DDQN strategies \cite{Ren2024,Okine2024,Singh2025Enhanced,Bhukya2025Hybrid}.

Collection and RPL-style protocols are especially important for deployment realism. CTP builds a collection tree toward the sink using link/path quality \cite{Gnawali2009CTP}, while RPL with MRHOF selects parents by minimizing path cost in a low-power and lossy-network DAG. Opportunistic variants such as ORPL/ORW go further by exploiting candidate forwarder sets and local link diversity. IEEE LCN has also carried adjacent WSN/IoT work, from SmartCoast to mobility-prediction routing, OSR, and decentralized broadcast trees \cite{OFlynn2007SmartCoast,Munari2009MobilityPrediction,Zhong2018OSR,Sterz2023BTP}. This paper does not claim to replace that whole family. Instead, it asks where a simpler fixed-rule WSN design still buys reliability, and where the stronger collection-tree family should remain the default.
