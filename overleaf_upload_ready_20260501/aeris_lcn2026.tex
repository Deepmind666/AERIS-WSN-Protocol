...
\caption{AERIS round pipeline. Phase 1 forms clusters, Phase 2 handles CAS-driven intra-cluster communication and CH aggregation, and Phase 3 performs pre-transmission uplink selection with direct, Gateway-assisted, Skeleton-reserve, and one-shot fallback branches.}
...
Figure~\ref{fig:aeris_workflow} summarizes the round pipeline in the same order: cluster formation, intra-cluster communication, and pre-transmission uplink selection to the BS.
