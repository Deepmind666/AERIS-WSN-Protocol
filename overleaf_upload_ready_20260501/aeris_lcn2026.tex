...
\begin{figure*}[t]
\centering
\includegraphics[width=0.98\textwidth]{fig0_aeris_round_pipeline_lcn26.pdf}
\caption{AERIS round pipeline with cluster formation, intra-cluster forwarding, and pre-transmission uplink selection.}
