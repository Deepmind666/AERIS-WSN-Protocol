...
\begin{table}[H]
\caption{PDR by environment at 100 nodes from a legacy comparability matrix (n=30 per environment-protocol cell; strict collision/relay flags disabled). Standard deviations are reported from replicate-level records in that matrix.}
\label{tab:pdr100}
\centering
\resizebox{\linewidth}{!}{
