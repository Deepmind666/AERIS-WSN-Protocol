...
\begin{figure}[H]
\centering
\includegraphics[width=0.98\textwidth]{fig0_aeris_workflow_20260228_s88.pdf}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.99\textwidth]{fig1_env_pdr_panel_20260228_s88.pdf}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.99\textwidth]{fig2_ablation_panel_20260228_s88.pdf}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.99\textwidth]{fig3_scalability_panel_20260228_s88.pdf}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.99\textwidth]{fig8_s8_significance_heatmap_20260228_s88.pdf}
\caption{Primary-matrix strongest-baseline map. (a) Cell-wise \(\Delta\)PDR to the strongest baseline (in percentage points), where the strongest baseline is selected by the largest baseline mean in each environment-node cell; tags L/P/H/T denote LEACH/PEGASIS/HEED/TEEN. (b) Holm-corrected significance strength \((-\log_{10}p)\) with effect size \(g\) and baseline tags. Hatched cells are Holm non-significant.}
\label{fig:s8_significance_map}
\end{figure}

Figure~\ref{fig:s8_significance_map} makes the strongest-baseline identity explicit in every cell, so the delta and significance statements in Table~\ref{tab:robust_snapshot} remain fully traceable to a concrete baseline protocol rather than an implicit pooled reference.
...
\begin{figure}[H]
\centering
\includegraphics[width=0.99\textwidth]{fig6_s10_delta_maps_20260228_s88.pdf}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.99\textwidth]{fig10_s10_absolute_profiles_20260228_s88.pdf}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.99\textwidth]{fig5_s11_patch_control_delta_20260228_s88.pdf}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.99\textwidth]{fig4_tradeoff_panel_20260228_s88.pdf}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.99\textwidth]{fig7_ns3_trend_panel_20260228_s88.pdf}
