...
\caption{Primary large-scale scalability trends over node counts (balanced n=3200 per environment-node-protocol cell) with 95\% CI bands. Explicit collision and relay modeling are enabled. AERIS remains rank-1 in three environments and declines with scale in all four environments.}
...
\begin{table}[H]
\caption{AERIS power-sensitivity snapshot at 1000 nodes (metric=\texttt{pdr\_expected}).}
