...
\abstract{This paper presents AERIS, an environment-aware hierarchical routing protocol for wireless sensor networks, and evaluates it using \texttt{pdr\_expected} as the primary metric. In the publication-tier 100-node matrix (four environments, 30 seeds per environment), AERIS achieves the highest mean PDR among LEACH, PEGASIS, HEED, and TEEN. In the balanced S8 scalability matrix (100--1000 nodes, four environments, 1000 replicates per environment-node-protocol cell), AERIS remains first by mean PDR in all 24 environment-scale cells. Because the original S8 path omits explicit MAC-collision penalties and shows non-physical upward trends in three environments, we treat S8 as baseline evidence and use S9/S10/S11 as rigor-calibration blocks. In S10 (tx-power 5 vs 15 dBm, n=600 per cell), 59/60 comparisons are significant after Holm correction. In matched S11 (patch n=1000, control n=1000), AERIS patch-control deltas are negative and significant in all 24 environment-scale cells, indicating reliability degradation under the current collision/relay patch configuration. NS-3 is used for cross-platform trend validation (AERIS vs LEACH) and is reported as trend-level evidence rather than numerical-equivalence proof.}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.97\textwidth]{fig0_aeris_workflow_20260221_s45.pdf}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.95\textwidth]{fig1_env_pdr_panel_20260221_s45.pdf}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.95\textwidth]{fig2_ablation_panel_20260221_s45.pdf}
...
This 1000-node ranking is listed in Table~\ref{tab:scale1000}.
...
\begin{figure}[H]
\centering
\includegraphics[width=0.95\textwidth]{fig3_scalability_panel_20260221_s45.pdf}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.95\textwidth]{fig8_s8_significance_heatmap_20260221_s45.pdf}
\caption{S8 significance map against the strongest baseline per environment-node cell. Panel (a) reports absolute delta (percentage points), and panel (b) reports significance strength as $-\log_{10}(p_{\mathrm{Holm}})$ with effect-size annotations.}
\label{fig:s8_significance_map}
\end{figure}

Figures~\ref{fig:scalability_panel} and~\ref{fig:s8_significance_map} jointly provide the S8 trend-and-significance view.
...
\begin{figure}[H]
\centering
\includegraphics[width=0.95\textwidth]{fig9_s9_s11_consistency_20260221_s45.pdf}
...
Table~\ref{tab:s10_aeris_1000} reports the 1000-node AERIS tx-power snapshot used in this section.
...
\begin{figure}[H]
\centering
\includegraphics[width=0.95\textwidth]{fig6_s10_power_sensitivity_20260221_s45.pdf}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.95\textwidth]{fig10_s10_absolute_profiles_20260221_s45.pdf}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.95\textwidth]{fig5_s11_patch_control_delta_20260221_s45.pdf}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.95\textwidth]{fig11_s11_significance_panel_20260221_s45.pdf}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.95\textwidth]{fig4_tradeoff_panel_20260221_s45.pdf}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.95\textwidth]{fig7_ns3_trend_panel_20260221_s45.pdf}
...
\section{Conclusion}
AERIS is a reliability-oriented routing option for heterogeneous WSN channels. In the publication-tier 100-node matrix, it achieves the highest mean PDR within the tested baseline set across all four environments. In the balanced S8 large-scale matrix (100--1000 nodes, n=1000 per cell), AERIS is also the highest-mean protocol in all tested environments; however, S8 remains baseline evidence because it excludes MAC-collision modeling and shows non-physical upward trends in three environments.
...
The practical conclusion is environment-scoped deployment: AERIS remains strong for reliability-first operation in harsh channels, while final high-scale parameterization should be selected under calibrated collision/relay settings rather than transferred directly from frozen baseline matrices.
