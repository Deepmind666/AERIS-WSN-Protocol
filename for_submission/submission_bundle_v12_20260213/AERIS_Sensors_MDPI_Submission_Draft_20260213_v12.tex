...
Recent adaptive or learning-based methods improve specific settings but often require heavier runtime or training overhead \cite{Ren2024,Okine2024,Chen2023Survey}. Context-aware routing studies further motivate explicit environmental adaptation in protocol design \cite{Liu2018Environment,Zhao2019Context}. In this manuscript, the focus is a rule-based protocol with explicit reproducibility constraints and auditable experiment metadata.
