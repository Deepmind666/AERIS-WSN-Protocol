...
\begin{table}[H]
\caption{PDR by environment at 100 nodes (mean $\pm$ std).}
\label{tab:pdr100}
\centering
\resizebox{\linewidth}{!}{
...
At 100 nodes, AERIS ranks first in all four tested environments within the evaluated baseline set (LEACH, PEGASIS, HEED, TEEN).
...
\begin{table}[H]
\caption{Full vs no\_gateway PDR (mean $\pm$ std).}
