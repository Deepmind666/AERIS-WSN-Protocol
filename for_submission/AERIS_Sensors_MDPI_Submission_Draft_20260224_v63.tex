...
\end{equation}
Eq.~(4) is therefore a conditional reliability decomposition aligned with the actual control flow. CAS chooses the lower-cost intra-cluster collection mode before this uplink stage, so routing overhead is bounded while uplink reinforcement remains available when direct quality is insufficient.
...
\begin{figure}[H]
\centering
\includegraphics[width=0.74\textwidth]{fig0_aeris_workflow_20260224_s62.pdf}
...
\begin{table}[H]
\caption{PDR by environment at 100 nodes from a legacy comparability matrix (n=30 per environment-protocol cell; strict collision/relay flags disabled). Values are shown at 4-decimal precision; minor last-digit differences come from rounding conventions in source records.}
\label{tab:pdr100}
\centering
\resizebox{\linewidth}{!}{
...
\begin{figure}[H]
\centering
\includegraphics[width=0.95\textwidth]{fig1_env_pdr_panel_20260224_s62.pdf}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.95\textwidth]{fig2_ablation_panel_20260224_s62.pdf}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.95\textwidth]{fig3_scalability_panel_20260224_s62.pdf}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.95\textwidth]{fig6_s10_delta_maps_20260224_s62.pdf}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.95\textwidth]{fig10_s10_absolute_profiles_20260224_s62.pdf}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.95\textwidth]{fig5_s11_patch_control_delta_20260224_s62.pdf}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.95\textwidth]{fig4_tradeoff_panel_20260224_s62.pdf}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.95\textwidth]{fig7_ns3_trend_panel_20260224_s62.pdf}
