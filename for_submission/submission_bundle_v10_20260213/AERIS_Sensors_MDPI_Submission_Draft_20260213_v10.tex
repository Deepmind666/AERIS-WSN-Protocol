...
\item Seeds for scalability: environment-specific sample sizes with n=550 (indoor factory uses n=650).
...
\begin{figure}[H]
\centering
\includegraphics[width=0.95\textwidth]{fig1_env_pdr_panel_20260213_s14.pdf}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.95\textwidth]{fig2_ablation_panel_20260213_s14.pdf}
...
AERIS is first in 3/4 environments in the large-scale matrix, while PEGASIS is higher in indoor\_office. This statement is matrix-specific and must not be interpreted as a pooled cross-environment ranking.
...
\begin{figure}[H]
\centering
\includegraphics[width=0.95\textwidth]{fig3_scalability_panel_20260213_s14.pdf}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.95\textwidth]{fig4_tradeoff_panel_20260213_s14.pdf}
...
This separation is deliberate: the 100-node block and the 100--1000-node block answer different questions and therefore should not be merged into a single headline number.
