...
Stress block A (stress-delta matrix, patch minus control) & 4 env $\times$ 6 node counts $\times$ 5 protocols & patch n=1000, control n=600 & Physics-stress calibration \\
