...
S10 adds a second calibration lens: tx-power effects are strong but not globally monotonic across environments and scales. Therefore, practical interpretation should avoid one-dimensional statements such as ``higher power is always better'' and should instead use environment-scoped claims.
