...
\caption{Primary large-scale scalability trends (n=3200 per cell, 95\% CI bands, common 0--1 y-axis).}
...
\caption{Power-sensitivity delta maps (\(\Delta\)PDR = tx5 $-$ tx15, percentage points; 120 cells). Cross markers: Holm non-significant.}
...
\caption{Absolute PDR profiles from the power-sensitivity matrix. Top row: AERIS (line style = tx level). Bottom row: baselines.}
...
\caption{NS-3 trend validation (50--1000 nodes). Primary pair: AERIS vs LEACH (bold lines, significance markers). Context: PEGASIS/HEED/TEEN (faded). Red hollow circles: Holm non-significant scales.}
