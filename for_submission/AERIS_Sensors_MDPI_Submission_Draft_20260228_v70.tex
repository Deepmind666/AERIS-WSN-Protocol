...
\begin{table}[H]
\caption{AERIS power-sensitivity snapshot at 1000 nodes (mean PDR, tx5 vs tx15) from the S10R matrix (n=1000 per cell).}
...
\midrule
indoor\_office    & 0.8176 & 0.5404 & +0.2771 \\
indoor\_factory   & 0.6633 & 0.5032 & +0.1601 \\
outdoor\_urban    & 0.0582 & 0.1634 & -0.1052 \\
outdoor\_suburban & 0.7679 & 0.5431 & +0.2249 \\
\bottomrule
\end{tabular}
\end{table}
