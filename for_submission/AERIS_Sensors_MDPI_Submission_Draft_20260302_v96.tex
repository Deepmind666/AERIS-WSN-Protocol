...
Additional recent studies show that routing quality is strongly coupled to link asymmetry, deployment context, and adaptive control-policy design \cite{Qin2024NLOSError,Jain2025Optimized,Ogundile2025PPRP,Singh2025Enhanced,Tossa2025Deployment,Prince2025Hotspot,Qin2026WBAN}. These results motivate explicit environmental adaptation in protocol design while keeping inference and control logic lightweight.
...
\begin{figure}[H]
\centering
\includegraphics[width=1.0\textwidth]{fig0_aeris_workflow_20260301_s93.pdf}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.99\textwidth]{fig1_env_pdr_panel_20260301_s93.pdf}
...
Gateway is positive in three environments and near-neutral in indoor\_office (Figure~\ref{fig:ablation_panel}). CAS is not consistently positive across environments.
In indoor\_office, the Full-vs-no\_gateway gap is +0.0002 (absolute PDR), so this cell is treated as practically neutral.

\begin{figure}[H]
\centering
\includegraphics[width=0.99\textwidth]{fig2_ablation_panel_20260302_s95.pdf}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.99\textwidth]{fig3_scalability_panel_20260301_s93.pdf}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.99\textwidth]{fig8_s8_significance_heatmap_20260301_s93.pdf}
...
To reduce seed and sampling confounders, we ran Stress-delta matrix A (patch-minus-control comparison) in all four environments (indoor\_office, indoor\_factory, outdoor\_urban, and outdoor\_suburban). The patch mode enables collision and baseline relay mechanisms; the control mode uses the legacy control configuration. Patch cells use n=1000 and control cells use n=600.

\begin{table}[H]
\caption{AERIS PDR in stress-delta matrix A (patch-minus-control comparison, four environments). The two curves correspond to patch/control executions under the same environment and node settings.}
...
\begin{tabular}{lcccc}
\toprule
Environment & Delta (stress-delta) & Hedges' $g$ & Holm $p$ & Significant \\
\midrule
...
\begin{figure}[H]
\centering
\includegraphics[width=0.99\textwidth]{fig6_s10_delta_maps_20260302_s95.pdf}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.99\textwidth]{fig10_s10_absolute_profiles_20260301_s93.pdf}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.99\textwidth]{fig5_s11_patch_control_delta_20260301_s93.pdf}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.99\textwidth]{fig4_tradeoff_panel_20260301_s93.pdf}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.99\textwidth]{fig7_ns3_trend_panel_20260301_s93.pdf}
