...
\caption{Scalability trends over node counts (indoor\_factory n=650, other environments n=550) with 95\% CI bands.}
...
The manuscript intentionally keeps three evidence blocks separate: (i) 100-node multi-environment comparison, (ii) large-scale matrix (100--1000 nodes) with mixed environment-specific sample sizes, and (iii) NS-3 trend validation for AERIS versus LEACH only. Cross-block numerical pooling is avoided.
