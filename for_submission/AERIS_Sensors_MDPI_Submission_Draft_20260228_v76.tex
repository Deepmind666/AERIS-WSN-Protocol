...
\begin{figure}[H]
\centering
\includegraphics[width=0.94\textwidth]{fig0_aeris_workflow_20260228_s76.pdf}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.95\textwidth]{fig1_env_pdr_panel_20260228_s76.pdf}
\caption{PDR comparison panel at 100 nodes (4 environments, n=30). The outdoor\_urban panel includes an inset (0--0.16 PDR) to make low-value baseline separation visible without changing the global 0--1 y-axis used in the main panel.}
\label{fig:env_panel}
\end{figure}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.95\textwidth]{fig2_ablation_panel_20260228_s76.pdf}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.95\textwidth]{fig3_scalability_panel_20260228_s76.pdf}
\caption{Primary large-scale scalability trends (n=3200 per cell, 95\% CI bands). Each panel includes all five protocols over six node counts on a common 0--1 y-axis; CI bands are shown for all lines and are narrow because of large n.}
...
\begin{table}[H]
\caption{AERIS power-sensitivity snapshot at 1000 nodes (mean PDR, tx5/tx10/tx15) from the power-sensitivity matrix (S10R; n=1000 per cell).}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.95\textwidth]{fig6_s10_delta_maps_20260228_s76.pdf}
\caption{Power-sensitivity delta maps (\(\Delta\)PDR = tx5 $-$ tx15, percentage points; 4 environments $\times$ 5 protocols $\times$ 6 node counts = 120 cells). No cells are filtered. Cross markers denote Holm non-significant cells.}
\label{fig:s10_power_sensitivity}
\end{figure}

\begin{figure}[H]
\centering
\includegraphics[width=0.95\textwidth]{fig10_s10_absolute_profiles_20260228_s76.pdf}
...
To remove remaining sample-size asymmetry from the stress comparison matrix, we completed a fully matched stress comparison (patch-control) confirmation matrix in which both patch and control arms use n=1000 per environment-node-protocol cell (4 environments $\times$ 6 node counts $\times$ 5 protocols). This matrix directly tests whether stricter physics assumptions improve or degrade reliability under matched sampling.
...
\begin{figure}[H]
\centering
\includegraphics[width=0.95\textwidth]{fig5_s11_patch_control_delta_20260228_s76.pdf}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.95\textwidth]{fig4_tradeoff_panel_20260228_s76.pdf}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.95\textwidth]{fig7_ns3_trend_panel_20260228_s76.pdf}
