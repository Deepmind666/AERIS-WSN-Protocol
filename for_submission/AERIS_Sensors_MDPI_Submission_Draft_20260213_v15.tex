...
\caption{Trade-off panel from publication-tier data: reliability, energy, hop-based latency, and lifetime. The hop panel includes a local zoom to resolve non-PEGASIS protocols under a highly skewed hop scale.}
