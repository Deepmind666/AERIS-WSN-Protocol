...
\caption{Absolute PDR profiles across the same S10R matrix, split for readability into an AERIS-focused row and a baseline-focused row. Line style denotes tx5/tx10/tx15, while color denotes protocol. This view complements Figure~\ref{fig:s10_power_sensitivity} by showing absolute levels rather than only deltas.}
