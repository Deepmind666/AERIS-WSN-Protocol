...
\begin{table}[H]
\caption{AERIS power-sensitivity snapshot at 1000 nodes (mean PDR, tx5 vs tx15).}
...
\caption{NS-3 trend panel over 50--1000 nodes, showing AERIS and LEACH PDR curves in each environment. Cross markers indicate node scales where the AERIS--LEACH difference is not significant after Holm correction; per-panel \(\Delta@1000\) annotations are reported in percentage points (pp).}
