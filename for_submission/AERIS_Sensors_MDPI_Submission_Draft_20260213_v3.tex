...
\begin{figure}[H]
\centering
\includegraphics[width=0.95\textwidth]{fig1_env_pdr_panel_20260213_s11.pdf}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.95\textwidth]{fig2_ablation_panel_20260213_s11.pdf}
...
For very large sample sizes, tiny mean differences can still produce small $p$ values; therefore, practical interpretation in this study follows both effect size and absolute PDR gap, not significance labels alone.
...
\begin{figure}[H]
\centering
\includegraphics[width=0.95\textwidth]{fig3_scalability_panel_20260213_s11.pdf}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.95\textwidth]{fig4_tradeoff_panel_20260213_s11.pdf}
...
The manuscript uses three distinct evidence blocks: (i) 100-node multi-environment protocol comparison, (ii) large-scale matrix (100--1000 nodes) with mixed environment-specific sample sizes, and (iii) NS-3 trend validation for AERIS versus LEACH only. Claims are intentionally scoped to the corresponding block.
...
\section{Conclusion}
AERIS provides a reliability-oriented routing option for heterogeneous WSN channels. In the publication-tier 100-node matrix, it attains the highest PDR among the tested baseline protocols across all four environments. In the large-scale matrix, it remains first in three of four environments, with indoor\_office as a stable counterexample where PEGASIS is higher. NS-3 confirms trend consistency for AERIS versus LEACH and is used strictly as trend-level evidence. Gateway effects are environment-dependent and CAS effects are mixed; therefore, claims are bounded to the tested protocol set, environments, and sample sizes.
