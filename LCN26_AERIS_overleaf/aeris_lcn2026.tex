...
Recent WSN work improves reliability through learning-based routing and optimization~\cite{kumar2019machine,hu2024security,pushpa2025optimizing}, context-aware deployment or energy management~\cite{tossa2025wireless,wang2024energy,khedr2025advancing}, and secure or swarm-assisted control~\cite{almutairi2025secured}. Recent surveys summarize the broader move toward AI-driven routing and LLN management~\cite{almutairi2024survey,djennadi2025exploring,thakur2025ai}, while reinforcement-learning and federated-DDQN designs explore more adaptive controllers~\cite{ren2023mefi,okine2024multi,singh2025enhanced,bhukya2025hybrid}. AERIS shares the context-awareness objective but deliberately keeps runtime logic fixed and auditable.
...
Classical audit scales & 50, 100, 200, 300, 500, 800, 1000 \\
Rounds per run & 300 \\
